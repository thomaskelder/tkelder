...
File[] attrFiles = [ 
   ...
   new File(dpath + "cy_Liver_relt0_1.txt"),
    ...
    new File(dpath + "cy_zscore_Liver_anova_q0.01_maxfc0.25.txt"),
    new File(dpath + "cy_zscore_Muscle_anova_q0.01_maxfc0.25.txt"),
    new File(dpath + "cy_zscore_WAT_anova_q0.01_maxfc0.25.txt")
];
...
String[] loadNetworks = [
    "anov_q0.01_maxfc0.25_WAT.sif",
    "anov_q0.01_maxfc0.25_Liver.sif",
    "anov_q0.01_maxfc0.25_Muscle.sif"
];

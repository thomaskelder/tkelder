 ...
 * 
 * Make sure to run with -Dmkdir=false!!
 * @author thomas
 */
public class GseaTimeHFvsLF {
	public static void main(String[] args) {
		GseaTimeHFvsLF main = new GseaTimeHFvsLF();
		try {
			main.start();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private File dataDir = new File(outDir.getAbsolutePath() + "/data");
	private File reportDir = new File(outDir.getAbsolutePath() + "/report");
...
//			"LF_t18_225",	"LF_t18_226",	"LF_t18_227",	"LF_t18_228",	"LF_t18_229",	"LF_t18_230",	"LF_t18_231",	"LF_t18_232",
//			"HF_t18_277",	"HF_t18_278",	"HF_t18_279",	"HF_t18_280",	"HF_t18_281",	"HF_t18_282",	"HF_t18_283",	"HF_t18_284",
//		});
		samples.put(timePoints[3], new String[] {
	...
	void start() throws Exception {
		...
		writeNESFile(new File(reportDir, "totalTable-min1.4.txt"), geneSetNames, scores, 1.4, false);
